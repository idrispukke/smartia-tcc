...
export default function RowTable({ key, link, nome, planos, usos }: RowsProps) {
     return (
          <TableRow key={key} className="w-full bg-zinc-900 px-2 mt-1 py-2 text-center items-center">
